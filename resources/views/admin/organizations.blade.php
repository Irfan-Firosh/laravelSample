<x-admin>
    ...
    <li>
        <a href="/admin/organizations" class="waves-effec activet"><i class="md md-event"></i><span> Organizations </span></a>
    </li>
    <li>
        ...
        <div class="card bg-light">
            <div class="card-body px-2 py-2">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-3 text-center">
                       <a href="/admin/organizations/create"><button class="btn btn-primary text-white px-4">Create Organization</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <div class="d-flex">
                    <a href="./organizations/update/{{$org->id}}" class="edit nav-link text-muted small-col"><i class="fa fa-edit edit"></i></a>
                    <a href="./organizations/delete/{{$org->id}}" class="del nav-link text-muted small-col"><i class="fa fa-trash-o del"></i></a>
                  </div>
                </td>
            </tr>
            @endforeach
