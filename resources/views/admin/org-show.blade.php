<x-admin>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h2 class="pull-left page-title"> Show Organization</h2>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col mx-1">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="" value="{{$org->name}}" readonly>
                                </div>
                                <div class="col">
                                    <label for="name">Email:</label>
                                    <input type="text" name="email" class="form-control" placeholder="" value="{{$org->email}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col mx-1">
                                    <label for="phone">Phone:</label>
                                    <input type="text" name="phone" class="form-control" placeholder="" value="{{$org->phone}}" readonly>
                                </div>
                                <div class="col">
                                    <label for="address">Address:</label>
                                    <input type="text" name="address" class="form-control" placeholder="" value="{{$org->address}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col mx-1">
                                    <label for="city">City:</label>
                                    <input type="text" name="city" class="form-control" placeholder="" value="{{$org->city}}" readonly>
                                </div>
                                <div class="col">
                                    <label for="province">Province/State:</label>
                                    <input type="text" name="province" class="form-control" placeholder="" value="{{$org->province}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col mx-1">
                                    <label for="country">Country:</label>
                                    <input type="text" name="country" class="form-control" placeholder="" value="{{$org->country}}" readonly>
                                </div>
                                <div class="col">
                                    <label for="code">Postal Code:</label>
                                    <input type="text" name="code" class="form-control" placeholder="" value="{{$org->code}}" readonly>
                                </div>
                            </div>
                        </div>
                        @if ($errors->any())
